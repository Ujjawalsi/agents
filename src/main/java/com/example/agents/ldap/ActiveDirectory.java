...
//                    System.out.println("Attr: "+attr);
    ...
    // temp purpose kpmg 25-07-2023
    public static User getUserr(String username, String arr[]) {
        try {
//            String domainName = null;
//            if (username.contains("@")){
//                username = username.substring(0, username.indexOf("@"));
...
//                }
    ...
    public static String getUserID(String domainName, String l_email, LdapContext context) {
        String uid = "";
        try {
            ...
            if (domainName != null) {
                ...
                controls.setReturningAttributes(userAttributes);
                NamingEnumeration<SearchResult> answer = context.search(toDC(domainName),
                        "(& (mail=" + l_email + ")(objectClass=user))", controls);
//                NamingEnumeration<SearchResult> answer = context.search( toDC(domainName), "(& (mail=manoj.gupta@velocis.in)(objectClass=user))", controls);
                if (answer.hasMore()) {
                    Attributes attr = answer.next().getAttributes();
                    System.out.println("Attr: " + attr);
    ...
    public static class User {
        ...
        public User(Attributes attr, String user_name) throws NamingException {
...
//            userPrincipal = "manoj.gupta@velocis.in";
            userPrincipal = user_name + "@" + Domain;
            commonName = user_name;
//            distinguishedName = "Manoj Gupta";
            distinguishedName = "";
//            Attribute email = attr.get("mail");
//            mail = user_name;
            name = user_name;
...
//                 System.out.println(attrs.get("cn"));
        ...
        public String toString() {
            return "User [distinguishedName=" + distinguishedName + ", userPrincipal=" + userPrincipal + ", commonName="
                    + commonName + ", mail=" + mail + ", role=" + role + ", name=" + name + "]";
        }
